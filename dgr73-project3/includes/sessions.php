...
?>
  ...
  <p class="login">
    ...
    foreach ($messages as $message) {
      echo "<p class=\"feed-1\">" . htmlspecialchars($message) . "</p>\n";
    } ?>
  </p>

  <form class="login-box" action="<?php echo htmlspecialchars($action) ?>" method="post" novalidate>
    ...
    <div class="align-right">
      <button name="login" type="submit" class="sign-up">Sign In</button>
    </div>
  </form>
<?php
}
